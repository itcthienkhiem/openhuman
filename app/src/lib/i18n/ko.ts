...
const messages: TranslationMap = {
  ...
  'skills.dashboard.scheduledHeading': '예약된 스킬',
  'skills.dashboard.emptyTitle': '예약된 스킬 없음',
  'skills.dashboard.emptyBody':
    '번들 스킬을 한 번 실행하거나 반복 일정을 저장하면 여기에 표시됩니다.',
  'skills.dashboard.create': '스킬 만들기',
  'skills.dashboard.run': '스킬 실행',
  'skills.dashboard.enable': '예약된 스킬 활성화',
  'skills.dashboard.disable': '예약된 스킬 비활성화',
  'skills.dashboard.lastRun': '마지막 실행',
  'skills.dashboard.nextRun': '다음 실행',
  'skills.dashboard.cardOpenRunner': '러너에서 열기',
  'skills.dashboard.loadError': '예약된 스킬을 불러오지 못했습니다',
  'skills.new.title': '스킬 만들기',
  'skills.new.placeholderBody':
    '편집 양식이 곧 제공됩니다. 지금은 러너 페이지의 "새 스킬" 버튼을 사용하세요.',
